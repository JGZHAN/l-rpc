...
public class LRPCDecoder extends ByteToMessageCodec<Message> {
    ...
    protected void encode(ChannelHandlerContext ctx, Message msg, ByteBuf out) throws Exception {
        ...
        out.writeByte(Config.serializerAlgorithm().ordinal());
        // 4. 序列号，4字节
        ...
        final var outContent = Config.serializerAlgorithm().serialize(msg);
        // 6. 消息长度， 4字节
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        // 3. 读取序列化算法
        final Serializer serializer = SerializerImpl.values()[in.readByte()];
        // 4. 读取序列号
