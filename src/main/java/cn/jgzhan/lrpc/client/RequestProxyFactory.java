...
public class RequestProxyFactory {
    ...
    private static final Logger log = LoggerFactory.getLogger(RequestProxyFactory.class);

    private static final ConsumerManager consumerManager = SingletonUtils.getSingletonInstance(ConsumerManager.class);

    public static <T> T getProxy(Class<T> clazz) {
        return getProxy(clazz, null);
    }

    public static <T> T getProxy(Class<T> clazz, Set<Pair<String, Integer>> serviceAddress) {
